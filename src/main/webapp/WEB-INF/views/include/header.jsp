    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav text-uppercase ml-auto">
          ...
          <li class="nav-item">
          <a class="nav-link js-scroll-trigger" href="http://localhost:8089/kh/enroll.do">회원가입</a>
          </li>
         </c:when>
         <c:otherwise>
          <li class="nav-item">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form action="http://localhost:8089/kh/login.do" name="sign-in" method="post" id="signInForm"
