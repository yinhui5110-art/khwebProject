...
<body>
    <div class="wrap">
        ...
        <div class="content">
            <br><br>
            <form action="http://localhost:8089/kh/order.do" method="get">
                ...
                <fieldset>
                    ...
                    <table>
                        ...
                        <tr>
                            <th>전화번호</th>
                            <td><input type="text" name="phoneNum" class="form-control" required></td>
                        </tr>
                        <tr>
                            <th>주소</th>
                            <td><input type="text" name="userAddress" class="form-control" required></td>
                        </tr>
                        <tr>
                            <th>요청사항</th>
                            <td><textarea name="requested" cols="80" rows="5" class="form-control" style="resize:none"></textarea></td>
                        </tr>
                    </table>
                </fieldset>
                ...
                <fieldset>
                    ...
                    <table>
                        ...
                        <tr>
                            <th>채소</th>
                            <td>
                                <input type="checkbox" name="cucumber" value="오이" checked><label>오이</label>
                                <input type="checkbox" name="cabbage" value="양배추" checked>양배추
                                <input type="checkbox" name="olive" value="올리브" checked>올리브
                                <input type="checkbox" name="jalapenos" value="할라피뇨" checked>할라피뇨
                                <input type="checkbox" name="redOnion" value="적양파" checked>적양파
                                <input type="checkbox" name="paprika" value="피망" checked>피망
                                <input type="checkbox" name="tomato" value="토마토" checked>토마토
                            </td>
                        </tr>
                        <tr>
                            <th>소스</th>
